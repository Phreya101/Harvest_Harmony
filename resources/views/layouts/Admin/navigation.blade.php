        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    {{-- <x-nav-link :href="route('admin.viewfaq.index')" :active="request()->routeIs('admin.viewfaq.index')">
                        {{ __('FAQS') }}
                    </x-nav-link>


                    <x-nav-link :href="route('admin.viewLM.index')" :active="request()->routeIs('admin.viewLM.index')">
                    ...
                    <x-nav-link :href="route('admin.Farmerslists.index')" :active="request()->routeIs('admin.Farmerslists.index')">
                        {{ __('Lists of Farmers') }}
                    </x-nav-link> --}}
