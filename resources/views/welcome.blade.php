...
<head>
    ...
    .hero-section {
        background: url('{{ asset('image/logo.jpg') }}') no-repeat center center;
        background-size: contain; /* Keeps the aspect ratio of the logo */
        min-height: 93vh; /* Minimum height for smaller screens */
        max-height: 100vh; /* Prevents overflowing on large screens */
        display: flex;
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    @if (Route::has('login'))
                        ...
                        @endauth
                        <li class="nav-item">
                            <a href="{{ route('users.feedback.create') }}" class="nav-link">Feedback</a>
                        </li>
                    @endif
                </ul>
            </div>
